...
const REVIEWS = [
  ...
  { name: '최유나 (21)', text: '인트로부터 도아 말투가 너무 현실적이라서 진짜 누군가랑 대화하는 느낌이었어요. 결과도 맞고 뭔가 위로받은 기분? 연애하다 힘들 때 다시 읽어봐야겠어요.' },
  ...
  { name: '강예진 (22)', text: '중간에 도아 반응이 너무 공감돼서 혼자 "맞아맞아" 하면서 했어요ㅋㅋ 결과도 정확하고 분위기가 좋아서 지루하지 않았어요.' },
  ...
  { name: '노수빈 (24)', text: '테스트 중에 도아 반응이 따뜻해서 좋았어요. 결과 나왔을 때 "맞아, 이래서 힘들었구나" 하는 느낌이었어요. 혼자 읽으면서 위로된 것 같아요.' },
  ...
  { name: '천서윤 (23)', text: '도아 말투가 진짜 누나 같아서 읽으면서 친근했어요. 결과 설명해주는 방식이 딱딱하지 않고 따뜻해서 부담 없이 읽혔어요.' },
  ...
  { name: '배나리 (22)', text: '답 고르면 도아가 반응해주는 게 좋았어요. 그냥 문항만 있는 게 아니라 대화하는 느낌이어서 더 집중하게 됐어요. 결과도 잘 맞아요.' },
  ...
  { name: '정하연 (26)', text: '이음나루 도아 말투가 진짜 편안해요. 채팅하는 느낌이라서 테스트인 줄 모르고 대화하다 보니까 끝났어요. 결과도 꽤 맞아요.' },
  ...
  { name: '강지훈 (25)', text: '도아 말투가 AI 느낌 없이 진짜 사람 같아서 좋았어요. 결과도 공감 포인트가 많고 읽으면서 많이 생각하게 됐어요.' },
  ...
  { name: '조유진 (21)', text: '도아가 대답할 때마다 위로해주는 느낌이었어요. 결과도 따뜻하게 써져 있어서 기분 좋게 마무리됐어요. 자주 돌아올 것 같아요.' },
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          {type.trap && (
            <div style={{ padding: '13px 15px', borderRadius: 13,
              ...
              <div style={{ fontSize: 10.5, color: c.accent, fontWeight: 900, letterSpacing: '1.3px', marginBottom: 7 }}>도아의 한 줄</div>
...
export default function ResultPage() {
  ...
  // 도아가 대본(BEATS) 밖에서 자유 메시지를 차례로 보내는 헬퍼 (신청 분기 대화용)
  ...
  // 신청 질문 한 단계를 도아가 물어본 뒤 입력창/칩을 연다
  ...
  // 신청 분기 ─ "아니, 다음에": 도아가 아쉬워하며 마무리, 공유/재신청만 남긴다
  const onApplyNo = () => {
    if (phase !== 'cta') return
